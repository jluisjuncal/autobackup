...
dol_include_once("/autobackup/class/myobject.class.php");


/**
 * mailing_mailinglist_autobackup
 */
class mailing_mailinglist_autobackup_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_autobackup_myobject';
	...
	var $picto='autobackup@autobackup';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('autobackup',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/autobackup/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_autobackup_myobject.modules.php: mailing ".$num." targets found");
