...
/**
 *	\file       htdocs/autobackup/template/autobackupindex.php
 *	\ingroup    autobackup
 *	\brief      Home page of autobackup top menu
 */
...
$langs->loadLangs(array("autobackup@autobackup"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->autobackup->read) accessforbidden();
...
llxHeader("",$langs->trans("autobackupArea"));

print load_fiche_titre($langs->trans("autobackupArea"),'','autobackup.png@autobackup');
...
// Draft MyObject
if (! empty($conf->autobackup->enabled) && $user->rights->autobackup->read)
{
	$langs->load("orders");
